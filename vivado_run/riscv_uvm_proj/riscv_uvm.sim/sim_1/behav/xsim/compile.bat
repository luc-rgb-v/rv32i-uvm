...
REM
REM Generated by Vivado on Mon Nov 10 01:01:34 +0700 2025
...
echo "xvlog --incr --relax -prj tb_risc_rv32i_vlog.prj"
call xvlog  --incr --relax -prj tb_risc_rv32i_vlog.prj -log xvlog.log
