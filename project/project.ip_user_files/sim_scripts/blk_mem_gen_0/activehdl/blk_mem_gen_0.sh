...
#
# Script generated by Vivado on Mon Nov 17 09:25:15 +0700 2025
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/Github/repositories/rv32i-uvm/project/project.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
